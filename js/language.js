...
const translations = {
  de: {
    ...
    project_join_live_aria: "Join Live Server öffnen",
    project_el_pollo_live_aria: "El Pollo Loco Live Server öffnen",
    project_pokedex_live_aria: "Pokedex Live Server öffnen",
  ...
  en: {
    ...
    project_join_live_aria: "Open Join live server",
    project_el_pollo_live_aria: "Open El Pollo Loco live server",
    project_pokedex_live_aria: "Open Pokedex live server",
